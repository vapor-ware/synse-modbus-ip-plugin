...
type ModbusOutputData struct {
	...
	// Divisor is the amount to divide by (scale by) to get the actual result.
	// This could be a float or int.
	Divisor float64 // TODO: Figure out if this is the same as OutputType.ScalingFactor.
	// For now, just get this to work at all.
}
